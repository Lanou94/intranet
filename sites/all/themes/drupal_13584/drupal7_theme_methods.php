...
function drupal_13584_process_html(&$variables) {
...
function drupal_13584_breadcrumb($variables) {
...
function drupal_13584_preprocess_page(&$vars) {
  $vars['tabs'] = menu_primary_local_tasks();
  $vars['tabs2'] = menu_secondary_local_tasks();
}


function drupal_13584_menu_local_task($variables) {
...
function drupal_13584_feed_icon($variables) {
...
function drupal_13584_node_preview($variables) {
  $node = $variables['node'];
